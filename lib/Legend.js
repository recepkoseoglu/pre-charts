            ...
            for (var key in legends) {
                if (legends.hasOwnProperty(key)) {
                    ...
                    arr.push(_react2.default.createElement(
                        "div",
                        {key: key, style: {borderColor: lengend.fill, color: lengend.fill}},
                        lengend.label
                    ));
                }
            }
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                {
                    ...
                    style: _extends({width: this.props.width, marginTop: 20, marginLeft: 40}, this.props.style)
                },
                _react2.default.createElement(
                    "div",
                    {className: "pre-thumbnail"},
                    this.__renderLegend()
                )
            );
        }
