...
var ScatterChart = function (_ShallowComponent) {
    _inherits(ScatterChart, _ShallowComponent);
    ...
    _createClass(ScatterChart, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { id: "scatter", style: { marginLeft: 40 } },
        ...
        key: "__renderScatters",
        value: function __renderScatters(data, meta) {
            var metaArr = [];
            for (var i in data) {
                var item = data[i];
