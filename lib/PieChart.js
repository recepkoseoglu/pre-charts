...
var _FaIcon = require("../faicon/FaIcon");
...
var PieChart = function (_ShallowComponent) {
    _inherits(PieChart, _ShallowComponent);
    ...
    _createClass(PieChart, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "rb-pie-chart-back-tool", style: { display: this.state.clicked ? "inherit" : "none" } },
                    _react2.default.createElement(_FaIcon2.default, { code: "fa-undo", onClick: this.__onClickReset })
                ),
                _react2.default.createElement(
                    "svg",
                ...
                _react2.default.createElement(_Legend2.default, { data: this.legends, width: this.props.size })
            );
        }
    }, {
        key: "__renderPies",
        value: function __renderPies(data, percentage, rotation, depth, depthIndex) {
        ...
        key: "__createPath",
        value: function __createPath(data, radius, percentage, rotaion, depth, depthIndex) {
            var sectors = [],
                mRadius = radius,
        ...
        key: "__onClickReset",
        value: function __onClickReset() {
            this.setState({ data: this.props.data, clicked: false });
        }
    }, {
        key: "__depthTree",
        value: function __depthTree(data) {
        ...
        key: "__sumValues",
        value: function __sumValues(data) {
            var max = 0;
            data.map(function (item, key) {
                var value = item.value;
                max += value;
