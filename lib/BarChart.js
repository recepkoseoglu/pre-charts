...
var BarChart = function (_ShallowComponent) {
    _inherits(BarChart, _ShallowComponent);
    ...
    _createClass(BarChart, [{
        ...
        key: "__renderBars",
        value: function __renderBars(data, meta) {
            var metaArr = [];
        ...
        key: "__barHeight",
        value: function __barHeight(value) {
            var maxYAxis = this.__maxYAxis();
            return this.props.height * (value * 100 / maxYAxis) / 100;
        }
    }, {
        key: "__barWidth",
        value: function __barWidth(data) {
